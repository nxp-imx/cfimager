...
// also update CStResource::map_err_rid
	STERR_END													=	-59,
	STERR_ERROR_OUT_OF_RANGE									=	-60,
// add those errors that do not have a message to display
	STERR_FAILED_TO_LOAD_RESOURCE_DLL							=   -61,
	STERR_ANOTHER_INSTANCE_RUNNING								=	-62,
	STERR_UNKNOWN_VENDOR_SPECIFIC_SENSE_CODE					=	-63,
	STERR_ERROR_IN_SETUPAPI_API									=	-64
} ST_ERROR;

extern TCHAR* g_ERROR_STR[];
