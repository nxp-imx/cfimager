...
{
	UCHAR		ConsistencyCheck[446];		// not used
...
public:
	...
	CStSDisk( ULONG _sectors, ULONG partitionSectors, ULONG hiddenSectors, 
		ULONG _sector_size, UCHAR* _vol_label, size_t _len, BOOL _fat16_only, ULONG fatPartNumber,
		string _name="CStDisk");
...
private:
	...
	ULONG				m_sectors;
	ULONG				m_partitionSectors;
	ULONG				m_hiddenSectors;
	ULONG				m_sector_size;
